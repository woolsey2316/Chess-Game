...
void DrillScreen::dragChessPiece()
{
  for(int i = 0; i < chesspieceSprite.size(); ++i){
...
MoveType DrillScreen::letGoOfPiece()
{
    isPressed = false;
...
void DrillScreen::moveSprite(MoveType moveType)
{
...
void DrillScreen::loadPosition(sf::RenderWindow &App)
{
  if (!isPressed) {
    chessboard.reset();
